...
```bash
git clone https://github.com/TU_USUARIO/lua-nvim-forge.git
cd lua-nvim-forge
```
...
2. Ponle un nombre a tu repositorio (ejemplo: `lua-nvim-forge`)
...
> Si el nombre del repo es el mismo (`lua-nvim-forge`), no necesitas cambiar nada.
